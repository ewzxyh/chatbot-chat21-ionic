...
export class UploadService {
  ...
  display(uidContact: string, format?: string) {
    //https://firebasestorage.googleapis.com/v0/b/chat-v2-dev.appspot.com/o/profiles%2F5aaa99024c3b110014b478f0%2Fthumb_photo.jpg?alt=media&token=[REDACTED_TOKEN]
