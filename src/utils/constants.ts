...
// URLS
export const URL_SEND_BY_EMAIL: string = "mailto:redacted@example.invalid?subject=Transcript Chat Conversation&body= Ciao, di seguito il transcript http://api.chat21.org/public/messages/";
